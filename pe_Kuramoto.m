...
estimated_theta = mean(theta_weighted_iter, 1);
theta_star = estimated_theta;

% MSE_Ms = [10, 50, 100, 500, 1000];
...
for i = 1:length(MSE_Ms)
    ...
    MSEs(i) = s / numBlocks;
    Costs(i) =  10 * avg_cost / numBlocks;  % average cost per block
end
...
% set(gcf, 'FontSize',14, 'Linewidth', 1.5);
